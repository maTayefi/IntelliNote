...
public class Console {
     ...
     *
     * @throws ArgsParseException Throws an exception if a value is missing.
     * @throws IOException
     */
     ...
     * @throws ArgsParseException
     * @throws ArgsParseException If the given key does not exist, or if the given value has
     *                            the wrong type.
     */
     ...
     * @throws InvalidInputFileException If the given config class does not end in .conf.
     */
