...
//		pp2.run();
     ...
     * returns false.
     *
     * @param pos_a First position in a double array.
     * @param pos_b Second position in a double array.
     ...
     *
     * @param ccEdges The object with the edge costs.
     */
     ...
     * the array is no. of nodes x dimension.
     *
     * @param ccPositions The array with the node positions.
     */
     ...
     * to address a certain object/node.
     *
     * @param objectIDs The array where the proper object IDs are saved in.
     */
     ...
     *
     * @param node_no The number of nodes for the connected component.
     */
...
//		setNumberOfClusters(noOfClusters);
     ...
     *
     * @param cluster_no The number of the cluster compliant with the numbering within
