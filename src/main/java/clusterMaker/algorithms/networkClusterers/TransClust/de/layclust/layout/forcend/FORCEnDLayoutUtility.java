...
public class FORCEnDLayoutUtility {
     ...
     * @param node_no   The number of nodes in the current ConnectedComponent.
     * @param param     The parameters object for this layouting instance.
...
//		double temp = Math.sqrt(dummy-(iteration*(dummy/param.getIterations())));
     ...
     *
     * @param allDisplacements The displacement array.
     * @param node_no          The number of nodes for the current ConnectedComponent.
...
//					double distance = calculateEuclideanDistance(cc.getCCPositions(), dim, i,j);
     ...
     *
     * @param node_pos The positions array with all node positions.
     * @param dim      The dimension that FORCEnD is run in.
     * @param node_i   Node i.
     * @param node_j   Node j.
     ...
     * this value.
     *
     * @param allDisplacements The double[][] with all calculated force vectors.
     * @param node_pos         The previous node positions.
     * @param node_no          The number of nodes.
     * @param dim              The dimension for this layouting instance.
     * @param temp             The cooling temperature factor.
     */
...
//			}
     ...
     *
     * @param positions All force vectors in one 2D double array.
     * @param node      The position in the array (first dim) for which the norm
     *                  should be calculated.
     * @param dim       The dimension of the force vector (second dim).
