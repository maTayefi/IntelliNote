...
public class PP_DivideAndReclusterRecursively implements IPostProcessing {
     ...
     *
     * @param finalClusterObject This should only include finished clusters that can not be
     *                           improved anymore by reclustering.
     * @param tmpClusterObject   This includes all clusters that are to be re-clustered.
     */
