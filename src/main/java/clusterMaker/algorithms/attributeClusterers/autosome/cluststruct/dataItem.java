...
public class dataItem implements Serializable {
    ...
    public void initNormValue(int size) {
        normValues = new float[size];
    }
    ...
    public String getDesc() {
        return (desc == null) ? "" : new String(desc);
    }

    public void setConf(int conf) {
        this.confidence = (short) conf;
    }
    ...
    public void setClustID(int id) {
        this.clusterID = (short) id;
    }
