...
public class DragGridPanel extends JPanel implements MouseListener,
     ...
     * @throws ArrayIndexOutOfBoundsException if not enough widths are supplied.
     */
     ...
     * @throws ArrayIndexOutOfBoundsException if not enough heights are supplied.
     */
     ...
     * @throws ArrayIndexOutofBoundsException if any of the parameters extend outside the array.
     * @throws IllegalArgumentException       if any of the space is already occupied.
     */
