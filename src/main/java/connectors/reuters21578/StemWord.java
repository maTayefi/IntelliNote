package connectors.reuters21578;
...
public class StemWord{
	...
	SolrClient server = new HttpSolrClient(
					       "http://localhost:8983/solr/gettingstarted_shard2_replica2");
    ...
    public static void getInitialProbabilities(SolrClient server,
    ...
    public static void trainData(String[] topicIndex, String[] tempKeyword,
				 ...
				 SolrClient server, Map<String, Double> initProbMap,
				 Map<String, ArrayList<String>> kNeighborsMap) {
	SolrQuery query;
	...
	try {
	    ...
	    brReader = new BufferedReader(new FileReader("src/main/resources/reuters-21578/topics.txt"));
		System.out.println("----------------------------");
    ...
    public static void testResult(Map<String, Double> probMap,
				  String[] topicIndex, SolrClient server,
    ...
    public static Double getQueryResponseDoc(SolrClient server,
