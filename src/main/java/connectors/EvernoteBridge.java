...
public class EvernoteBridge {
    ...
    private static final String AUTH_TOKEN = "S=s1:U=92db7:E=1619472e86d:C=15a3cc1bc30:P=1cd:A=en-devtoken:V=2:H=cd739d224821e8e0cdbb6b9e32be6e0a";
    ...
    public static void main(String args[]) throws Exception {
        ...
        if ("S=s1:U=92db7:E=1619472e86d:C=15a3cc1bc30:P=1cd:A=en-devtoken:V=2:H=cd739d224821e8e0cdbb6b9e32be6e0a".equals(token)) {
            System.err.println("S=s1:U=92db7:E=1619472e86d:C=15a3cc1bc30:P=1cd:A=en-devtoken:V=2:H=cd739d224821e8e0cdbb6b9e32be6e0a");
            System.err
                    .println("To get a developer token, go to https://sandbox.evernote.com/api/DeveloperToken.action");
            //return;
        }

        EvernoteBridge evernoteBridge = new EvernoteBridge(token);
        try {
            evernoteBridge.listNotes();
            //demo.createNote();
            //demo.searchNotes();
            //demo.updateNoteTag();
     ...
     */
    public EvernoteBridge(String token) throws Exception {
    ...
    private void createNote() throws Exception {
        ...
        Note note = new Note();
        note.setTitle("Test note from Demo.java");
    ...
    private static Data readFileAsData(String fileName) throws Exception {
        String filePath = new File(EvernoteBridge.class.getResource(
                EvernoteBridge.class.getCanonicalName() + ".class").getPath()).getParent()
