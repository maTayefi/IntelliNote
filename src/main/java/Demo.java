...
public class Demo {
     ...
     */
    public Demo(String token) throws Exception {
    ...
    private static Data readFileAsData(String fileName) throws Exception {
        String filePath = new File(Demo.class.getResource(
                Demo.class.getCanonicalName() + ".class").getPath()).getParent()
